...
class TestMain {
	...
	void testReadFile() throws Exception {
		...
		String expected = "";
		ByteArrayInputStream in = new ByteArrayInputStream("readfile ./src/TestSamples/1-perfect.txt".getBytes());
		System.setIn(in);
		Main.main(null);
	...
	@Test
	void testZExit() throws Exception {
		...
		Main.main(null);
		String actual = getOutput();
		System.out.println("QQQQQQQQQQQQQQQQQQQQQQQQQQQQQ" + actual + "QQQQQQQQQQQQQQQQQQQQQQ");
		assertEquals(expected, actual);
	}
