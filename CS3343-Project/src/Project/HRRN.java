...
public class HRRN extends Algorithm {
	...
	public static HRRN getInstance() { return instance; }
	...
	public ArrayList<ProcessInCPU> schedule(ArrayList<Process> processes) {
        ...
        for (int tick = 0; tick < Constants.MAX_LOOP; tick++) {
            ...
            if (readyQueue.isEmpty()) {
            	...
            	if (!isBusy) {
            		int highestRatioIndex = ProcessInCPU.findHighestResponseRatioProcess(readyQueue);
            		Collections.swap(readyQueue, 0, highestRatioIndex);
            		isBusy = true;
            	}
